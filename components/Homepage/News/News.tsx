    ...
    return (
        <div className="w-full py-[60px] px-[100px]">
            ...
            <div className="flex gap-6 mt-20">
                <div className="h-[220px] w-[100%] bg-white flex gap-6 pr-8">
                    ...
                    <div>
                        ...
                        <button className="bg-nav w-[100%] mt-4 h-12 text-sm font-semibold text-white font-oswald rounded">Read More</button>
                    </div>
                </div>
                <div className="h-[220px] w-[100%] bg-white flex gap-6 pr-8">
