...
const Event: FC<any> = () => {
    return (
        <div className="w-full bg-event p-[60px]">
            <div className="flex flex-col justify-center items-center">
                <h1 className="text-[35px] font-bold leading-tight text-nav font-oswald pb-[10px]">Upcoming Events</h1>
                <div className="w-[50px] h-[1.8px] bg-nav"></div>
            </div>
            <div className="w-full flex gap-6 justify-between px-[60px] mt-[40px]">
                <div className="w-[33%] h-[470px] bg-white">
                    ...
                    <div className="px-[32px] py-[24px]">
                        ...
                        <p className="text-[12px] mt-[10px] font-oswald text-mission">Join our interactive life skills workshop to develop essential tools for effective communication, decision-making, time management, and stress reduction.</p>
