...
const Sponsor: FC<any> = () => {
    return (
        <div className="mt-10 px-9 md:px-0">
            <h1 className="text-[35px] md:ml-[100px] font-bold leading-tight text-nav font-oswald md:border-b-2 md:border-b-nav md:w-14 text-center whitespace-nowrap">Our Partner</h1>
            <p className="text-[14px] md:ml-[100px] font-oswald text-mission mt-[26px] text-center md:text-left">Our partner provide us vital support and resources that enable us to deliver high-quality programs and services to our community.</p>
