...
const Justice: FC<any> = () => {
    return (
        <div className="flex flex-wrap md:flex-nowrap items-center bg-pillar pt-12 gap-[40px] px-4 md:pl-[130px] pb-[70px]">
            <div className="md:w-[50%]">
                ...
                <div className="flex md:gap-24 justify-between md:justify-normal my-10 md:m-10">
                    <div className="text-center">
                        <h2 className="md:text-[50px] text-[24px] font-bold text-nav">32</h2>
                        <p className="text-[20px] font-bold text-nav">Individual</p>
                    </div>
                    <div className="text-center">
                        <h2 className="md:text-[50px] text-[24px] font-bold text-nav">8</h2>
                        <p className="text-[20px] font-bold text-nav">Volunteer</p>
                    </div>
                    <div className="text-center">
                        <h2 className="md:text-[50px] text-[24px] font-bold text-nav">96</h2>
            ...
            <div className="md:w-[50%]">
                ...
                <div className="md:w-[70%] w-[90%] h-[550px] relative mt-[-300px] bg-white shadow-3xl mx-auto md:ml-[50px]">
