    ...
    return (
        <div className="bg-event py-14 px-9 md:px-0">
            <div className="flex flex-col justify-center items-center">
                <h1 className="md:text-[35px] text-[28px] font-bold leading-tight text-nav font-oswald pb-[10px]">Our Partner</h1>
                <div className="hidden md:block w-[50px] h-[1.8px] bg-nav"></div>
            </div>
            <p className="text-[14px] md:ml-[100px] font-oswald text-mission mt-[26px] text-center">Our partner provide us vital support and resources that enable us to deliver high-quality programs and services to our community.</p>
